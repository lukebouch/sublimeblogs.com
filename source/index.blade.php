    ...
    <section class="py-16 sm:py-24" id="notify-me">
        <div class="relative sm:py-16">
            ...
            <div class="max-w-md px-4 mx-auto sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
                <div class="relative px-6 py-10 overflow-hidden shadow-xl rounded-2xl bg-primary-600 sm:px-12 sm:py-20">
                    ...
                    <div class="relative">
                        <div class="text-white sm:text-center">
                            <h2 class="text-3xl font-extrabold tracking-tight sm:text-4xl">Get notified when
                                we&rsquo;re launching.</h2>
                            <p class="max-w-2xl mx-auto mt-6 text-lg">We are not quite ready yet. We are still working on
                        ...
                        <form action="{{ $page['apiUrl'] }}/newsletter/contact/add" method="POST"
                            ...
                            <div class="mt-4 sm:mt-0 sm:ml-3">
                                <button type="submit" class="block w-full h-full btn-secondary">Notify
                                    me</button>
                            </div>
                        </form>
                    </div>
